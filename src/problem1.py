...
def run_test_problem1a():
    ...
    # Test 4:
    expected = -0.511  # This is APPROXIMATELY the correct answer.
    answer = problem1a(6, 8)
    print()
...
def run_test_problem1b():
    ...
    # Test 4:
    expected = 12  # This is APPROXIMATELY the correct answer.
    answer = problem1b(6, 8)
    print()
    print('Test 4 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
